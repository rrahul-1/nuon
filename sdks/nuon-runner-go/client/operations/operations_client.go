...
func (a *Client) GetRunnerJobPlanV2(params *GetRunnerJobPlanV2Params, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetRunnerJobPlanV2OK, error) {
	...
	op := &runtime.ClientOperation{
		...
		Method:             "GET",
		PathPattern:        "/v1/runners/{runner_id}/jobs/{job_id}/plan",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"https"},
		Params:             params,
...
/*
GetRunnerProcessShutdowns gets shutdowns for a runner process
*/
func (a *Client) GetRunnerProcessShutdowns(params *GetRunnerProcessShutdownsParams, opts ...ClientOption) (*GetRunnerProcessShutdownsOK, error) {
	// NOTE: parameters are not validated before sending
	if params == nil {
		params = NewGetRunnerProcessShutdownsParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "GetRunnerProcessShutdowns",
		Method:             "GET",
		PathPattern:        "/v1/runners/{runner_id}/processes/{process_id}/shutdowns",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &GetRunnerProcessShutdownsReader{formats: a.formats},
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	for _, opt := range opts {
	...
	// only one success response has to be checked
	success, ok := result.(*GetRunnerProcessShutdownsOK)
	if ok {
		return success, nil
	}
...
/*
RunnerAuthAWSIID authenticates a runner using a w s instance identity document

Validates runner identity by verifying an AWS-signed instance identity document
*/
func (a *Client) RunnerAuthAWSIID(params *RunnerAuthAWSIIDParams, opts ...ClientOption) (*RunnerAuthAWSIIDOK, error) {
	// NOTE: parameters are not validated before sending
	if params == nil {
		params = NewRunnerAuthAWSIIDParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "RunnerAuthAWSIID",
		Method:             "POST",
		PathPattern:        "/v1/runner-auth/aws-iid",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &RunnerAuthAWSIIDReader{formats: a.formats},
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	for _, opt := range opts {
	...
	// only one success response has to be checked
	success, ok := result.(*RunnerAuthAWSIIDOK)
	if ok {
		return success, nil
	}
	...
	//
	// safeguard: normally, in the absence of a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for RunnerAuthAWSIID: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
