...
func (o *CreateRunnerHeartBeatReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 404:
		...
		return nil, result
	case 409:
		result := NewCreateRunnerHeartBeatConflict()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewCreateRunnerHeartBeatConflict creates a CreateRunnerHeartBeatConflict with default headers values
func NewCreateRunnerHeartBeatConflict() *CreateRunnerHeartBeatConflict {
	return &CreateRunnerHeartBeatConflict{}
}

/*
CreateRunnerHeartBeatConflict describes a response with status code 409, with default header values.

Conflict
*/
type CreateRunnerHeartBeatConflict struct {
	Payload *models.StderrErrResponse
}

// IsSuccess returns true when this create runner heart beat conflict response has a 2xx status code
func (o *CreateRunnerHeartBeatConflict) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this create runner heart beat conflict response has a 3xx status code
func (o *CreateRunnerHeartBeatConflict) IsRedirect() bool {
	return false
}

// IsClientError returns true when this create runner heart beat conflict response has a 4xx status code
func (o *CreateRunnerHeartBeatConflict) IsClientError() bool {
	return true
}

// IsServerError returns true when this create runner heart beat conflict response has a 5xx status code
func (o *CreateRunnerHeartBeatConflict) IsServerError() bool {
	return false
}

// IsCode returns true when this create runner heart beat conflict response a status code equal to that given
func (o *CreateRunnerHeartBeatConflict) IsCode(code int) bool {
	return code == 409
}

// Code gets the status code for the create runner heart beat conflict response
func (o *CreateRunnerHeartBeatConflict) Code() int {
	return 409
}

func (o *CreateRunnerHeartBeatConflict) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /v1/runners/{runner_id}/heart-beats][%d] createRunnerHeartBeatConflict %s", 409, payload)
}

func (o *CreateRunnerHeartBeatConflict) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /v1/runners/{runner_id}/heart-beats][%d] createRunnerHeartBeatConflict %s", 409, payload)
}

func (o *CreateRunnerHeartBeatConflict) GetPayload() *models.StderrErrResponse {
	return o.Payload
}

func (o *CreateRunnerHeartBeatConflict) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
