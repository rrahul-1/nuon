...
func (m *PlantypesSandboxRunPlan) validateGcpAuth(formats strfmt.Registry) error {
...
func (m *PlantypesSandboxRunPlan) contextValidateGcpAuth(ctx context.Context, formats strfmt.Registry) error {
