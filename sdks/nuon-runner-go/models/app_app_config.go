...
func (m *AppAppConfig) validateStatusV2(formats strfmt.Registry) error {
...
func (m *AppAppConfig) contextValidateStatusV2(ctx context.Context, formats strfmt.Registry) error {
