...
// AppAdHocStepConfig app ad hoc step config
//
// swagger:model app.AdHocStepConfig
type AppAdHocStepConfig struct {
...
// Validate validates this app ad hoc step config
func (m *AppAdHocStepConfig) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *AppAdHocStepConfig) validateConnectedGithubVcsConfig(formats strfmt.Registry) error {
...
func (m *AppAdHocStepConfig) validatePublicGitVcsConfig(formats strfmt.Registry) error {
...
// ContextValidate validate this app ad hoc step config based on the context it is used
func (m *AppAdHocStepConfig) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *AppAdHocStepConfig) contextValidateConnectedGithubVcsConfig(ctx context.Context, formats strfmt.Registry) error {
...
func (m *AppAdHocStepConfig) contextValidatePublicGitVcsConfig(ctx context.Context, formats strfmt.Registry) error {

	return nil
}

// MarshalBinary interface implementation
func (m *AppAdHocStepConfig) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *AppAdHocStepConfig) UnmarshalBinary(b []byte) error {
	var res AppAdHocStepConfig
