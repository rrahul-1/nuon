...
func (m *ServiceUpdateInstallConfigRequest) validateCustomNestedStacks(formats strfmt.Registry) error {
...
func (m *ServiceUpdateInstallConfigRequest) contextValidateCustomNestedStacks(ctx context.Context, formats strfmt.Registry) error {
