...
func (m *AppInstall) validateLabels(formats strfmt.Registry) error {
...
func (m *AppInstall) contextValidateLabels(ctx context.Context, formats strfmt.Registry) error {
