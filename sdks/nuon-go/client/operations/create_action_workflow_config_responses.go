...
func (o *CreateActionWorkflowConfigReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 404:
		...
		return nil, result
	case 409:
		result := NewCreateActionWorkflowConfigConflict()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewCreateActionWorkflowConfigConflict creates a CreateActionWorkflowConfigConflict with default headers values
func NewCreateActionWorkflowConfigConflict() *CreateActionWorkflowConfigConflict {
	return &CreateActionWorkflowConfigConflict{}
}

/*
CreateActionWorkflowConfigConflict describes a response with status code 409, with default header values.

Conflict
*/
type CreateActionWorkflowConfigConflict struct {
	Payload *models.StderrErrResponse
}

// IsSuccess returns true when this create action workflow config conflict response has a 2xx status code
func (o *CreateActionWorkflowConfigConflict) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this create action workflow config conflict response has a 3xx status code
func (o *CreateActionWorkflowConfigConflict) IsRedirect() bool {
	return false
}

// IsClientError returns true when this create action workflow config conflict response has a 4xx status code
func (o *CreateActionWorkflowConfigConflict) IsClientError() bool {
	return true
}

// IsServerError returns true when this create action workflow config conflict response has a 5xx status code
func (o *CreateActionWorkflowConfigConflict) IsServerError() bool {
	return false
}

// IsCode returns true when this create action workflow config conflict response a status code equal to that given
func (o *CreateActionWorkflowConfigConflict) IsCode(code int) bool {
	return code == 409
}

// Code gets the status code for the create action workflow config conflict response
func (o *CreateActionWorkflowConfigConflict) Code() int {
	return 409
}

func (o *CreateActionWorkflowConfigConflict) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /v1/action-workflows/{action_workflow_id}/configs][%d] createActionWorkflowConfigConflict %s", 409, payload)
}

func (o *CreateActionWorkflowConfigConflict) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /v1/action-workflows/{action_workflow_id}/configs][%d] createActionWorkflowConfigConflict %s", 409, payload)
}

func (o *CreateActionWorkflowConfigConflict) GetPayload() *models.StderrErrResponse {
	return o.Payload
}

func (o *CreateActionWorkflowConfigConflict) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
