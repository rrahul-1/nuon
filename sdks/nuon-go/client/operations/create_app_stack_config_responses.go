...
func (o *CreateAppStackConfigReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 404:
		...
		return nil, result
	case 409:
		result := NewCreateAppStackConfigConflict()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewCreateAppStackConfigConflict creates a CreateAppStackConfigConflict with default headers values
func NewCreateAppStackConfigConflict() *CreateAppStackConfigConflict {
	return &CreateAppStackConfigConflict{}
}

/*
CreateAppStackConfigConflict describes a response with status code 409, with default header values.

Conflict
*/
type CreateAppStackConfigConflict struct {
	Payload *models.StderrErrResponse
}

// IsSuccess returns true when this create app stack config conflict response has a 2xx status code
func (o *CreateAppStackConfigConflict) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this create app stack config conflict response has a 3xx status code
func (o *CreateAppStackConfigConflict) IsRedirect() bool {
	return false
}

// IsClientError returns true when this create app stack config conflict response has a 4xx status code
func (o *CreateAppStackConfigConflict) IsClientError() bool {
	return true
}

// IsServerError returns true when this create app stack config conflict response has a 5xx status code
func (o *CreateAppStackConfigConflict) IsServerError() bool {
	return false
}

// IsCode returns true when this create app stack config conflict response a status code equal to that given
func (o *CreateAppStackConfigConflict) IsCode(code int) bool {
	return code == 409
}

// Code gets the status code for the create app stack config conflict response
func (o *CreateAppStackConfigConflict) Code() int {
	return 409
}

func (o *CreateAppStackConfigConflict) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /v1/apps/{app_id}/stack-configs][%d] createAppStackConfigConflict %s", 409, payload)
}

func (o *CreateAppStackConfigConflict) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /v1/apps/{app_id}/stack-configs][%d] createAppStackConfigConflict %s", 409, payload)
}

func (o *CreateAppStackConfigConflict) GetPayload() *models.StderrErrResponse {
	return o.Payload
}

func (o *CreateAppStackConfigConflict) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
