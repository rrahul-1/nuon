...
type GetInstallStateOK struct {
	Payload *models.GithubComNuoncoNuonPkgTypesStateState
}
...
func (o *GetInstallStateOK) GetPayload() *models.GithubComNuoncoNuonPkgTypesStateState {
	return o.Payload
}
...
func (o *GetInstallStateOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.GithubComNuoncoNuonPkgTypesStateState)
