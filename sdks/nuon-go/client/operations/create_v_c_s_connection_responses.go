...
func (o *CreateVCSConnectionReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 404:
		...
		return nil, result
	case 409:
		result := NewCreateVCSConnectionConflict()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewCreateVCSConnectionConflict creates a CreateVCSConnectionConflict with default headers values
func NewCreateVCSConnectionConflict() *CreateVCSConnectionConflict {
	return &CreateVCSConnectionConflict{}
}

/*
CreateVCSConnectionConflict describes a response with status code 409, with default header values.

Conflict
*/
type CreateVCSConnectionConflict struct {
	Payload *models.StderrErrResponse
}

// IsSuccess returns true when this create v c s connection conflict response has a 2xx status code
func (o *CreateVCSConnectionConflict) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this create v c s connection conflict response has a 3xx status code
func (o *CreateVCSConnectionConflict) IsRedirect() bool {
	return false
}

// IsClientError returns true when this create v c s connection conflict response has a 4xx status code
func (o *CreateVCSConnectionConflict) IsClientError() bool {
	return true
}

// IsServerError returns true when this create v c s connection conflict response has a 5xx status code
func (o *CreateVCSConnectionConflict) IsServerError() bool {
	return false
}

// IsCode returns true when this create v c s connection conflict response a status code equal to that given
func (o *CreateVCSConnectionConflict) IsCode(code int) bool {
	return code == 409
}

// Code gets the status code for the create v c s connection conflict response
func (o *CreateVCSConnectionConflict) Code() int {
	return 409
}

func (o *CreateVCSConnectionConflict) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /v1/vcs/connections][%d] createVCSConnectionConflict %s", 409, payload)
}

func (o *CreateVCSConnectionConflict) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /v1/vcs/connections][%d] createVCSConnectionConflict %s", 409, payload)
}

func (o *CreateVCSConnectionConflict) GetPayload() *models.StderrErrResponse {
	return o.Payload
}

func (o *CreateVCSConnectionConflict) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
