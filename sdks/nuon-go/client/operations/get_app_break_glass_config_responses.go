...
func (o *GetAppBreakGlassConfigReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /v1/apps/{app_id}/break-glass-configs/{config_id}] GetAppBreakGlassConfig", response, response.Code())
	}
}
...
func (o *GetAppBreakGlassConfigOK) Error() string {
	...
	return fmt.Sprintf("[GET /v1/apps/{app_id}/break-glass-configs/{config_id}][%d] getAppBreakGlassConfigOK %s", 200, payload)
}
...
func (o *GetAppBreakGlassConfigBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /v1/apps/{app_id}/break-glass-configs/{config_id}][%d] getAppBreakGlassConfigBadRequest %s", 400, payload)
}
...
func (o *GetAppBreakGlassConfigUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /v1/apps/{app_id}/break-glass-configs/{config_id}][%d] getAppBreakGlassConfigUnauthorized %s", 401, payload)
}
...
func (o *GetAppBreakGlassConfigForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /v1/apps/{app_id}/break-glass-configs/{config_id}][%d] getAppBreakGlassConfigForbidden %s", 403, payload)
}
...
func (o *GetAppBreakGlassConfigNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /v1/apps/{app_id}/break-glass-configs/{config_id}][%d] getAppBreakGlassConfigNotFound %s", 404, payload)
}
...
func (o *GetAppBreakGlassConfigInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /v1/apps/{app_id}/break-glass-configs/{config_id}][%d] getAppBreakGlassConfigInternalServerError %s", 500, payload)
}
