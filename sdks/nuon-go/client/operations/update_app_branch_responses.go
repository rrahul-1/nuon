...
func (o *UpdateAppBranchReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[PATCH /v1/apps/{app_id}/branches/{app_branch_id}] UpdateAppBranch", response, response.Code())
	}
}
...
func (o *UpdateAppBranchOK) Error() string {
	...
	return fmt.Sprintf("[PATCH /v1/apps/{app_id}/branches/{app_branch_id}][%d] updateAppBranchOK %s", 200, payload)
}
...
func (o *UpdateAppBranchOK) GetPayload() *models.AppAppBranch {
	return o.Payload
}
...
func (o *UpdateAppBranchBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /v1/apps/{app_id}/branches/{app_branch_id}][%d] updateAppBranchBadRequest %s", 400, payload)
}
...
func (o *UpdateAppBranchUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /v1/apps/{app_id}/branches/{app_branch_id}][%d] updateAppBranchUnauthorized %s", 401, payload)
}
...
func (o *UpdateAppBranchForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /v1/apps/{app_id}/branches/{app_branch_id}][%d] updateAppBranchForbidden %s", 403, payload)
}
...
func (o *UpdateAppBranchNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /v1/apps/{app_id}/branches/{app_branch_id}][%d] updateAppBranchNotFound %s", 404, payload)
}
...
func (o *UpdateAppBranchInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /v1/apps/{app_id}/branches/{app_branch_id}][%d] updateAppBranchInternalServerError %s", 500, payload)
}
