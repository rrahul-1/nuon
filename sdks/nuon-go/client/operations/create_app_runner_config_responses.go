...
func (o *CreateAppRunnerConfigReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 404:
		...
		return nil, result
	case 409:
		result := NewCreateAppRunnerConfigConflict()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewCreateAppRunnerConfigConflict creates a CreateAppRunnerConfigConflict with default headers values
func NewCreateAppRunnerConfigConflict() *CreateAppRunnerConfigConflict {
	return &CreateAppRunnerConfigConflict{}
}

/*
CreateAppRunnerConfigConflict describes a response with status code 409, with default header values.

Conflict
*/
type CreateAppRunnerConfigConflict struct {
	Payload *models.StderrErrResponse
}

// IsSuccess returns true when this create app runner config conflict response has a 2xx status code
func (o *CreateAppRunnerConfigConflict) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this create app runner config conflict response has a 3xx status code
func (o *CreateAppRunnerConfigConflict) IsRedirect() bool {
	return false
}

// IsClientError returns true when this create app runner config conflict response has a 4xx status code
func (o *CreateAppRunnerConfigConflict) IsClientError() bool {
	return true
}

// IsServerError returns true when this create app runner config conflict response has a 5xx status code
func (o *CreateAppRunnerConfigConflict) IsServerError() bool {
	return false
}

// IsCode returns true when this create app runner config conflict response a status code equal to that given
func (o *CreateAppRunnerConfigConflict) IsCode(code int) bool {
	return code == 409
}

// Code gets the status code for the create app runner config conflict response
func (o *CreateAppRunnerConfigConflict) Code() int {
	return 409
}

func (o *CreateAppRunnerConfigConflict) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /v1/apps/{app_id}/runner-configs][%d] createAppRunnerConfigConflict %s", 409, payload)
}

func (o *CreateAppRunnerConfigConflict) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /v1/apps/{app_id}/runner-configs][%d] createAppRunnerConfigConflict %s", 409, payload)
}

func (o *CreateAppRunnerConfigConflict) GetPayload() *models.StderrErrResponse {
	return o.Payload
}

func (o *CreateAppRunnerConfigConflict) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
