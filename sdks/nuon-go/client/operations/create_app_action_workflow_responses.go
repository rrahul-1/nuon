...
func (o *CreateAppActionWorkflowReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 404:
		...
		return nil, result
	case 409:
		result := NewCreateAppActionWorkflowConflict()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewCreateAppActionWorkflowConflict creates a CreateAppActionWorkflowConflict with default headers values
func NewCreateAppActionWorkflowConflict() *CreateAppActionWorkflowConflict {
	return &CreateAppActionWorkflowConflict{}
}

/*
CreateAppActionWorkflowConflict describes a response with status code 409, with default header values.

Conflict
*/
type CreateAppActionWorkflowConflict struct {
	Payload *models.StderrErrResponse
}

// IsSuccess returns true when this create app action workflow conflict response has a 2xx status code
func (o *CreateAppActionWorkflowConflict) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this create app action workflow conflict response has a 3xx status code
func (o *CreateAppActionWorkflowConflict) IsRedirect() bool {
	return false
}

// IsClientError returns true when this create app action workflow conflict response has a 4xx status code
func (o *CreateAppActionWorkflowConflict) IsClientError() bool {
	return true
}

// IsServerError returns true when this create app action workflow conflict response has a 5xx status code
func (o *CreateAppActionWorkflowConflict) IsServerError() bool {
	return false
}

// IsCode returns true when this create app action workflow conflict response a status code equal to that given
func (o *CreateAppActionWorkflowConflict) IsCode(code int) bool {
	return code == 409
}

// Code gets the status code for the create app action workflow conflict response
func (o *CreateAppActionWorkflowConflict) Code() int {
	return 409
}

func (o *CreateAppActionWorkflowConflict) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /v1/apps/{app_id}/action-workflows][%d] createAppActionWorkflowConflict %s", 409, payload)
}

func (o *CreateAppActionWorkflowConflict) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /v1/apps/{app_id}/action-workflows][%d] createAppActionWorkflowConflict %s", 409, payload)
}

func (o *CreateAppActionWorkflowConflict) GetPayload() *models.StderrErrResponse {
	return o.Payload
}

func (o *CreateAppActionWorkflowConflict) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
