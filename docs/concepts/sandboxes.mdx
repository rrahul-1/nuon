...
keywords: ["sandboxes", "what is a sandbox", "base infrastructure", "set up Kubernetes cluster", "EKS", "AKS", "VPC", "cluster provisioning", "sandbox outputs", "sandbox.toml", "managed sandboxes", "BYO-VPC", "bring your own VPC", "per-customer sandbox", "VPC creation"]
---
