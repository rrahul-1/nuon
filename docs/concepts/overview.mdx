...
icon: "compass"
keywords: ["BYOC", "bring your own cloud", "concepts", "platform overview", "how Nuon works", "BYOC vs SaaS", "BYOC vs single tenant", "BYOC vs self-hosted", "build vs buy BYOC", "build BYOC in-house alternative", "managed BYOC", "BYOC as a service", "BYOC deployment platform"]
---
