...
Nuon is built around three pillars: connecting your app for BYOC delivery, supporting customer infrastructure, and enabling continuous delivery. This section covers the core concepts behind each.
...
How your customers interact with and manage their installs.

<CardGroup cols={2}>

  <Card title="Customer Portal" icon="users" href="/concepts/customer-portal">
