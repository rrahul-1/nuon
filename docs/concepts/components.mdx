...
keywords: ["components", "what are components", "Helm chart", "Terraform module", "Kubernetes manifest", "Docker build", "container image", "component types", "component builds", "OCI artifacts"]
---
