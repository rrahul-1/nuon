...
description:
  ...
  configure your app."
keywords: ["inputs", "what are inputs", "app inputs", "customer provided values", "inputs.toml", "input groups", "user configurable", "install parameters", "configure sandboxes and components"]
---
