...
keywords: ["actions", "what are actions", "health checks", "cron schedule", "action triggers", "day 2 operations", "database migrations", "kubectl", "bash scripts", "operational runbooks", "post-deploy", "pre-provision", "break glass actions", "remediation actions", "one-off commands", "ad-hoc operations", "scripted operations"]
---
