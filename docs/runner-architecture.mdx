---
title: 'Architecture'
description: "How the egress-only Nuon Runner enables BYOC deployments without requiring cross-account access to customer infrastructure."
keywords: ["Nuon Runner", "runner architecture", "egress-only runner", "BYOC architecture", "control plane", "install runner", "build runner", "cross-account access", "customer infrastructure", "Nuon Control API", "CloudFormation stack", "runner provisioning"]
---
