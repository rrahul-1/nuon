...
keywords: ["TOML config", "app directory structure", "metadata.toml", "sandbox.toml", "inputs.toml", "components directory", "config file reference", "TOML configuration", "app.toml", "config files", "app config", "configuration overview"]
---
