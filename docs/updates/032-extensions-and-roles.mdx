...
<iframe
  src="https://www.youtube.com/embed/63qBsCQeZnc?autoplay=1&mute=1&loop=1&playlist=63qBsCQeZnc&controls=0&showinfo=0&modestbranding=1&rel=0"
  frameBorder={0}
  allowFullScreen
  style={{ width: "100%", aspectRatio: "16/9", border: "none", borderRadius: "0.75rem", display: "block" }}
/>
...
- Fixed React hook bug causing deploy pages to crash.
