...
If you are not using Homebrew, you can use our install script to automatically download and install the correct binary for your platform (macOS or Linux):
...
Or, if you installed via the install script, simply run it again to get the latest version. For manual binary installs, download the latest version from the S3 bucket as described above.
