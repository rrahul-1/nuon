...
- AWS — Nuon deploys on EKS with RDS, ECR, Route 53, ACM, and Secrets Manager.
- Azure — AKS with Azure SQL, ACR, Blob Storage, and Key Vault.
- GCP — GKE with Cloud SQL, GAR, GCS, and Secret Manager.
