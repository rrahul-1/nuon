...
icon: "cloud-arrow-up"
keywords: ["self-hosted Nuon", "install Nuon", "AWS deployment", "Nuon setup", "BYOC installation", "Nuon BYOC architecture", "control plane in your AWS", "Cloud-Prem", "Vendor-Managed Self-Hosted", "self-hosted control plane"]
---
