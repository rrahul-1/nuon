...
1. Once Nuon BYOC has fully provisioned, the domains of DNS servers for the install will be available in the outputs.
...
Finally, you can optionally enable additional identity providers.
