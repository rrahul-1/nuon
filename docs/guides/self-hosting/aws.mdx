---
title: 'Self Hosting Nuon: AWS'
description: 'Deploy Nuon in your AWS account'
icon: 'cloud-arrow-up'
keywords: ['self-hosted Nuon', 'Install Nuon', 'AWS Deployment']
---
...
> [!NOTE]
> Our helm configs make heavy use of annotations for nodepool selection because we use
> Karpenter. We recommend deploying to an EKS cluster with Karpenter installed or EKS Auto Mode.
<!-- prettier-ignore-start --!>
