...
Installing the runner happens out of band, entirely on the customer's side. You just need to provide them with directions. We provide these for each install as part of the provision workflow.
...
Just like installing the runner, uninstalling it happens out of band. The instructions are provided in the deprovision workflow.
