...
This guide covers how to configure the three parameterization mechanisms in Nuon: [inputs](/concepts/app-inputs), [variables](/concepts/app-variables), and [secrets](/concepts/app-secrets).
