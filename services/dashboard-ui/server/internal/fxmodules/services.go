...
var ServicesModule = fx.Module("services",
	...
	fx.Provide(asService(handlers.NewBuildTimelineHandler)),
	fx.Provide(asService(handlers.NewDeployTimelineHandler)),
	fx.Provide(asService(handlers.NewSandboxBuildTimelineHandler)),
