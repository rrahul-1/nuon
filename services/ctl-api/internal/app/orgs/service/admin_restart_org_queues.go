...
import (
	...
	orgrestartqueues "github.com/nuonco/nuon/services/ctl-api/internal/app/orgs/signals/restart_queues"
...
func (s *service) RestartOrgQueues(ctx *gin.Context) {
	...
	if err := s.enqueueOrgSignal(ctx, queueID, &orgrestartqueues.Signal{OrgID: org.ID}, org.ID); err != nil {
