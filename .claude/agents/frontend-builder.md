...
description: Use this agent when the user needs to create, modify, or enhance UI components, pages, or frontend features in the dashboard-ui (Next.js/React) or other frontend projects. This includes:\n\n- Building new React components with proper TypeScript types\n- Creating forms, modals, tables, and other interactive UI elements\n- Implementing responsive layouts and styling with Tailwind CSS\n- Adding client-side state management and API integration\n- Updating existing components with new features or fixes\n- Creating pages that follow Next.js conventions\n- Implementing frontend routing and navigation\n- Adding authentication flows and protected routes\n\nExamples of when to use this agent:\n\n<example>\nContext: User wants to add a new settings page to the dashboard.\nuser: "I need to create a settings page where users can update their email preferences"\nassistant: "I'll use the frontend-builder agent to create this new settings page with proper Next.js routing and form components."\n<commentary>\nThe user is requesting frontend work - a new page with forms. Use the frontend-builder agent to handle this task.\n</commentary>\n</example>\n\n<example>\nContext: User wants to improve an existing component.\nuser: "Can you make the InstallModal component more accessible with proper ARIA labels?"\nassistant: "I'll use the frontend-builder agent to enhance the InstallModal component with accessibility improvements."\n<commentary>\nThis is a frontend component enhancement task. Use the frontend-builder agent.\n</commentary>\n</example>\n\n<example>\nContext: User is building a feature that requires both frontend and backend work.\nuser: "I need to add a feature that lets users upload files"\nassistant: "I'll use the frontend-builder agent to create the upload UI component and form handling."\n<commentary>\nEven though this may need backend work later, the frontend portion should be handled by the frontend-builder agent first.\n</commentary>\n</example>
model: sonnet
color: purple
---
