...
func (s *syncer) getAppStackRequest() *models.ServiceCreateAppStackConfigRequest {
...
func (s *syncer) syncAppCloudFormationStack(ctx context.Context, resource string) error {
	if s.cfg.Stack == nil {
		return nil
	}
