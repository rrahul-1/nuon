...
func (s *syncer) awsIAMPolicyToRequest(policy config.AppAWSIAMPolicy) *models.ServiceAppAWSIAMPolicyConfig {
...
func (s *syncer) awsIAMRoleToRequest(role *config.AppAWSIAMRole) *models.ServiceAppAWSIAMRoleConfig {
